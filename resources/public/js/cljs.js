...
words.fjall = words.subs_suit.call(null, "fjall", "fjalli\u00f0", "fj\u00f6ll", "fj\u00f6llin", "fjall", "fjalli\u00f0", "fj\u00f6ll", "fj\u00f6llin", "fjalli", "fjallinu", "fj\u00f6llum", "fj\u00f6llunum", "fjalls", "fjallsins", "fjalla", "fjallanna", "fj\u00e4ll", "fj\u00e4llet", "fj\u00e4ll", "fj\u00e4llen", "\ufdd0'neutr");
words.mynd = words.subs_suit.call(null, "mynd", "myndin", "myndir", "myndirnar", "mynd", "myndina", "myndir", "myndirnar", "mynd", "myndinni", "myndum", "myndunum", "myndar", "myndarinnar", "mynda", "myndanna", "bild", "bilden", "bilder", "bilderna", "\ufdd0'fem");
...
words.all_items = cljs.core.shuffle.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.EMPTY, words.hestur, words.fjall, words.mynd));
var clojure = {string:{}};
...
client.on_select_lang = function() {
  return setTimeout(client.show_new_word_BANG_, 10)
};
client.submit.addEventListener("click", client.on_submit);
client.ask_both.addEventListener("click", client.on_select_lang);
client.ask_isl.addEventListener("click", client.on_select_lang);
client.ask_sve.addEventListener("click", client.on_select_lang);
